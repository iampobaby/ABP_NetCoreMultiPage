...
using NetCoreMultiPage.Sessions;
using NetCoreMultiPage.Web.Models.Account;
using NetCoreMultiPage.Web.Views.Shared.Components.TenantChange;

namespace NetCoreMultiPage.Web.Controllers
{
    public class AccountController : NetCoreMultiPageControllerBase
    {
